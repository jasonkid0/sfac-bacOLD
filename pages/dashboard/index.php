            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="card card-stats">
                ...
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <?php
                        //     $result10 = mysqli_query($db,"SELECT * FROM tbl_online_registrations 
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="card card-stats">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <p class="card-category">Total No. of <br>Enrolled Students in  <br><strong>School of Business Administration <br>(SBA)</strong></p>
                  <?php
                            $result2 = mysqli_query($db,"SELECT * 
                              FROM tbl_schoolyears 
                              LEFT JOIN tbl_courses ON tbl_courses.course_id = tbl_schoolyears.course_id
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="card card-stats">
                <div class="card-header card-header-default card-header-icon">
                  ...
                  <p class="card-category">Total No. of <br>Enrolled Students in  <br><strong>School of Computer Studies <br> (SCS)</strong></p>
                  <?php
                            $result2 = mysqli_query($db,"SELECT * 
                              FROM tbl_schoolyears 
                              LEFT JOIN tbl_courses on tbl_courses.course_id = tbl_schoolyears.course_id
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <p class="card-category">Total No. of <br>Enrolled Students in <br><strong>School of Education and Liberal Arts<br> (SELA)</strong></p>
                  <?php
                            $result2 = mysqli_query($db,"SELECT * 
                              FROM tbl_schoolyears 
                              LEFT JOIN tbl_courses on tbl_courses.course_id = tbl_schoolyears.course_id
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">Total No. of <br>Enrolled Students in  <br><strong>School of Hospitality Management <br> (SHM)</strong></p>
                  <?php
                            $result2 = mysqli_query($db,"SELECT * 
                              FROM tbl_schoolyears 
                              LEFT JOIN tbl_courses on tbl_courses.course_id = tbl_schoolyears.course_id
