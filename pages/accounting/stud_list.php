                          ...
                          # code...
                                ...
                                $query = mysqli_query($db, 
                                  ...
                                  while ($row= mysqli_fetch_array ($query)){
                                    ...
                                    <td>
                                    <a class="btn btn-primary" for="ViewAdmin" href="acc_view_student.php<?php echo '?stud_id='.$id; ?>">
                                    <i class="fa fa-edit"></i> View Info</a>
                                    <!-- <a class="btn btn-primary" for="ViewAdmin" href="#">
