            ...
            <form method="GET">
              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  <h3 class="card-title ">Open Subjects for BSBA - FM for all Year Level  (NEW CURRICULUM) </h4>
...
?>
                  ...
                  <a href="open_subj.php?course_id=25" class="btn btn-success">
