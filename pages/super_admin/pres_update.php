...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($db," UPDATE tbl_presidents SET pres_img='$image', pres_lastname='$lname',pres_firstname='$fname', pres_middlename='$mname', email='$email', username='$username', password='$hashedPwd' where pres_id = '".$_SESSION['userid']."'")or die (mysqli_error($db));
    if($query == true)
    {
        ...
        { echo '
                    <div class="card-profile">
                      <div class="card-avatar">
                          <img class="img" src="data:image/jpeg;base64,'.base64_encode( $row['pres_img'] ).'" />
                      </div>
                      <div class="card-body">
