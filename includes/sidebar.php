...
?>
        ...
        <a href="../dashboard/" class="simple-text logo-normal"><?php echo ''.$row['side_name'].''; ?></a>
<?php
  }
?>
...
<?php 
  if($_SESSION['role'] == "Super Administrator")
  {
    echo '<li class="nav-item">
            <a class="nav-link" href="../super_admin/dean_list">
              <i class="material-icons">list_alt</i>
              <p>Deans List</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../super_admin/admin_list">
              <i class="material-icons">list_alt</i>
              <p>Registrar List</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../accounting/accounting_list">
              <i class="material-icons">list_alt</i>
              <p>Accounting List</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../accounting/add_accounting">
              <i class="material-icons">person_add</i>
              <p>Add Accounting</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../super_admin/add_admin">
              <i class="material-icons">person_add</i>
              <p>Add Registrar</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../dean/add_dean">
              <i class="material-icons">person_add</i>
              <p>Add Dean</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../super_admin/add_pres">
              <i class="material-icons">person_add</i>
              <p>Add President</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admission/add_admission">
              <i class="material-icons">person_add</i>
              <p>Add Admission Staff</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admission/admission">
              <i class="material-icons">person_add</i>
              <p>Admission Staff</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../skol_info/school_info">
              <i class="material-icons">settings</i>
              <p>School Info</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../super_admin/sidebar_setting">
              <i class="material-icons">settings</i>
              <p>Sidebar Setting</p>
            </a>   
          </li>';
  ...
  elseif($_SESSION['role'] == "Admission Staff")
  {
    echo '
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admission/user_prof">
              <i class="material-icons">person</i>
              <p>User Profile</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admission/target">
              <i class="material-icons">list</i>
              <p>Enrollment Target</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../forms/enroll_stats">
              <i class="material-icons">list</i>
              <p>Enrollment Breakdown</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admission/send_report">
              <i class="material-icons">list</i>
              <p>Send Report</p>
            </a>
          </li>';
        ...
        while ($row = mysqli_fetch_array($que))
        {
          ...
          <li class="nav-item">
                <a class="nav-link" href="../user/history.php?stud_id='.$_SESSION['userid'].'">
                  <i class="material-icons">person</i>
                  <p><strong>Your Grade History</strong></p>
                </a>
              </li>';
  }
  ...
  elseif($_SESSION['role'] == "President")
  {
        echo '
          <li class="nav-item">
            <a class="nav-link" href="../super_admin/pres_update">
              <i class="material-icons">person</i>
              <p>User Profile</p>
            </a>
          </li>
    ...
    elseif($_SESSION['role'] == "Dean")
  {
        echo '
          <li class="nav-item">
            <a class="nav-link" href="../dean/profile">
              <i class="material-icons">person</i>
              <p>User Profile</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="../faculty/add_faculty">
              <i class="material-icons">person_add</i>
              <p>Add Enrollment Adviser</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../dean/advisers">
              <i class="material-icons">list</i>
              <p>Enrollment Advisers</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../dean/add_department">
              <i class="material-icons">add</i>
              <p>Add Department</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../dean/department">
              <i class="material-icons">list</i>
              <p>Department List</p>
            </a>
          </li>
  ...
  { 
        ...
        <li class="nav-item">
              <a class="nav-link" href="../stud_list/stud_list">
  ...
  { 
        ...
        <li class="nav-item">
          ...
          <!--============================ DROPDOWN 2ND LEVEL============================-->
            ...
            <div class="dropdown-container" style="display: none;padding-left: 8px;">
              <li class="nav-item">
                <a class="nav-link" href="../forms/preenrollment">
                  <i class="material-icons">list</i>
                  <p>Pre-Enrollment Form</p>
                </a>
              </li>
          ...
          <div class="dropdown-container" style="display: none;padding-left: 8px;">
            <li class="nav-item">
              <a class="nav-link" href="../registrar/student">
                <i class="material-icons">wc</i>
                <p>Student List</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../registrar/faculty">
            ...
            <div class="dropdown-container" style="display: none;padding-left: 8px;">
              <li class="nav-item">
                <a class="nav-link" href="../subject/subj_list_new">
                  <i class="material-icons">book</i>
                  <p>Subject List(New Curri)</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../subject/subj_list">
                  <i class="material-icons">book</i>
            ...
            <li class="nav-item">
              <a class="nav-link" href="../registrar/course">
                <i class="material-icons">folder</i>
                <p>Course List</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../registrar/acadyear">
          ...
          <!--============================ DROPDOWN 2ND LEVEL============================-->
            <li class="nav-item dropdown2">
              <a class="nav-link">
                <i class="material-icons">add</i>
                <p>2020 Curriculum <span class="caret"></span></p>
              </a>
            </li>
            <div class="dropdown-container" style="display: none;padding-left: 8px;">
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/cs2020">
                <i class="fas fa-laptop-code fa-lg"></i>
                <p> 2020BSCS</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/mm2020">
                <i class="fas fa-bullhorn fa-lg"></i>
                <p> 2020BSMM</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/fm2020">
                <i class="fas fa-credit-card fa-lg"></i>
                <p> 2020BSFM</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/hm2020">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2020BSHM</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/educEngl2020">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2020BSED-ENGL</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/educFil2020">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2020BSED-FILI</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/educMath2020">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2020BSED-MATH</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/beed2020">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2020BEEd</p>
                </a>
              </li>
            ...
            <li class="nav-item dropdown2">
              <a class="nav-link">
                <i class="material-icons">add</i>
                <p>2018 Curriculum <span class="caret"></span></p>
              </a>
            </li>
            <div class="dropdown-container" style="display: none;padding-left: 8px;">
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/ncurri-db-rev">
                <i class="fas fa-laptop-code fa-lg"></i>
                <p> 2018BSCS</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/ncurri-ba-mktg-mgmt">
                <i class="fas fa-bullhorn fa-lg"></i>
                <p> 2018BSMM</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/ncurri-ba-fncl-mgmt">
                <i class="fas fa-credit-card fa-lg"></i>
                <p> 2018BSFM</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/ncurri-hm">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2018BSHM</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/ncurri-educ-eng">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2018BSED-ENGL</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/ncurri-educ-fil">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2018BSED-FILI</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/ncurri-educ-math">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2018BSED-MATH</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/ncurri-educ-eced">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2018BECEd</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/ncurri-educ-pe">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2018BPED</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/ncurri-educ-beed">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2018BEED</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../new_curr/ncurri-tcp">
                <i class="fas fa-chalkboard-teacher fa-lg"></i>
                <p> 2018TCP</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-bridging">
                <i class="fas fa-archway fa-lg"></i>
                  <p> 2018Bridging</p>
                </a>
              </li>
          ...
          <!--============================ DROPDOWN 2ND LEVEL============================-->
            ...
            <div class="dropdown-container" style="display: none;padding-left: 8px;">
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-educ-bio">
                <i class="material-icons"></i>
                  <p> BSED Biological Science</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-educ-eng">
                <i class="material-icons"></i>
                  <p> BSED English</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-educ-fil">
                <i class="material-icons"></i>
                  <p> BSED Filipino</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-educ-phys">
                <i class="material-icons"></i>
                  <p> BSED Physical Science</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-educ-math">
                <i class="material-icons"></i>
                  <p> BSED Mathematics</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-educ-eced">
                <i class="material-icons"></i>
                  <p> BEED Early Childhood</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-educ-sped">
                <i class="material-icons"></i>
                  <p> BEED Special Education</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-db">
                <i class="material-icons"></i>
                  <p> BSCS</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-db-tuyir">
                <i class="material-icons"></i>
                  <p> ACT</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-ba-mktg-mgmt">
                <i class="material-icons"></i>
                  <p> BSBA Marketing Management</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-ba-mgmt">
                <i class="material-icons"></i>
                  <p> BSBA Management</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../old_curr/curri-hrm">
                <i class="material-icons"></i>
                  <p> BSHRM</p>
                </a>
              </li>
            ...
            <div class="dropdown-container" style="display: none;padding-left: 8px;">
              <li class="nav-item">
                <a class="nav-link" href="../senior_curr/ncurri-db-rev">
                <i class="fas fa-laptop-code fa-lg"></i>
                <p> ABM </p>
                </a>
              </li>
          ...
          <div class="dropdown-container" style="display: none;padding-left: 8px;">
            <li class="nav-item">
            <a class="nav-link" href="../user/add_user">
              <i class="material-icons">person_add</i>
              <p>Add Student</p>
            </a>
          </li>
            <li class="nav-item">
              <a class="nav-link" href="../registrar/add_acadyear">
                <i class="material-icons">add_alarm</i>
                <p>Add Academic Year</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../registrar/add_course">
                <i class="material-icons">note_add</i>
                <p>Add Course</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../registrar/add_dept">
                <i class="material-icons">note_add</i>
                <p>Add Department</p>
              </a>
            </li>
            ...
            <div class="dropdown-container" style="display: none;padding-left: 8px;">
              <li class="nav-item">
                <a class="nav-link" href="../subject/add_subj">
                  <i class="material-icons">library_add</i>
                  <p>Add Old Subject</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../subject/add_subj_new">
                  <i class="material-icons">library_add</i>
                  <p>Add New Subject</p>
                </a>
              </li>
            ...
            <!--===========================END DROPDOWN 2ND LEVEL===========================-->
            <li class="nav-item">
              <a class="nav-link" href="../registrar/add_faculty">
                <i class="material-icons">person_add</i>
                <p>Add Faculty</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../setting/setting">
                <i class="material-icons">settings</i>
     ...
     elseif($_SESSION['role'] == "Faculty")
  {
        echo '
          <li class="nav-item">
              <a class="nav-link" href="../enroll/assess_stud">
                <i class="material-icons">list</i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="../faculty/edit_prof">
